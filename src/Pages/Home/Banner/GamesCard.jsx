        ...
        <div className="group relative bg-linear-to-br from-white/90 to-gray-100 rounded-2xl overflow-hidden  flex flex-col h-full border border-gray-500">
          <figure className="relative overflow-hidden">
            <img
              ...
              alt={title}
            />
            <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/10 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300" />
          </figure>

          <div className="card-body px-4 py-5 flex flex-col justify-between grow">
            <div>
              <h2
                className="card-title text-lg sm:text-xl font-semibold text-gray-900 dark:text-white
